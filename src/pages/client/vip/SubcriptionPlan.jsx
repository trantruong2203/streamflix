        ...
        >
            ...
            <div className='relative z-10'>
                ...
                <div className='text-gray-700 mb-4 border-b border-gray-200 pb-4'>
                    <p className='text-2xl font-bold text-blue-600'>{plan.PricePerMonth}đ
                ...
                return (
                    <div className='space-y-3'>
                        <div className='flex items-center gap-2'>
                            ...
                            <span>Có quảng cáo</span>
                        </div>
                        <div className='flex items-center gap-2'>
                            <GoCheck className='text-green-500' size={16} />
                            <span>Xem trên thiết bị di động</span>
                        </div>
                        <div className='flex items-start gap-2'>
                            <GoCheck className='text-green-500 mt-1' size={16} />
                            <span>Kho phim có sẵn với hơn 5.000 giờ nội dung đặc sắc</span>
                        </div>
                    </div>
                );
            case "2":
                return (
                    <div className='space-y-3'>
                        ...
                        <div className='flex items-start gap-2'>
                            <GoCheck className='text-green-500 mt-1' size={16} />
                            <span>Kho phim có sẵn với hơn 10.000 giờ nội dung đặc sắc</span>
                        </div>
                    </div>
                );
            case "3":
                return (
                    <div className='space-y-3'>
                        ...
                        <div className='flex items-start gap-2'>
                            <GoCheck className='text-green-500 mt-1' size={16} />
                            <span>Toàn bộ đặc quyền gói Cao Cấp</span>
                        </div>
                        <div className='flex items-start gap-2'>
                            <GoCheck className='text-green-500 mt-1' size={16} />
                            <span>Kho phim thuê Việt Nam và Châu Á với loạt siêu phẩm chiếu rạp độc quyền</span>
                        </div>
                    </div>
                );
            case "4":
                return (
                    <div className='space-y-3'>
                        ...
                        <div className='flex items-start gap-2'>
                            <GoCheck className='text-green-500 mt-1' size={16} />
                            <span>Xem không giới hạn kho phim thuê Việt Nam, Châu Á và Hollywood có một không hai</span>
                        </div>
                    </div>
                );
            default:
                return (
                    <div className='flex items-center gap-2'>
                        <GoCheck className='text-green-500' size={16} />
                        <span>Gói dịch vụ không xác định</span>
                    </div>
                );
        }
    };
        ...
        <div className='min-h-screen py-25 bg-gradient-to-br from-gray-50 to-gray-100'>
            <div className='max-w-7xl mx-auto px-4'>
                ...
                <div className='flex justify-center'>
                    <button onClick={() => navigate('/payment')} className='bg-blue-600 text-white px-30 py-2 rounded-full align-center font-semibold text-2xl cursor-pointer hover:bg-blue-700 transition-all duration-300'>Tiếp tục</button>
                </div>
